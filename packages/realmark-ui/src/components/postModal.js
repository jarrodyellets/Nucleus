    ...
    <div className="modalWrapper">
      <div className="modalWindowWrapper">
        <div className="modalWindow">
          ...
          {props.trigger.modal & !props.trigger.comment && <DisplayComment handleSelectedPost={props.handleSelectedPost} post={props.trigger.currentPost} handleModal={props.handleModal} comments={props.post.comments} id={props.user.id} handleSearch={props.handleSearch} handleTrigger={props.handleTrigger} />}
