      ...
      <div className="postHeadingWrapper">
        ...
        <div className="commentHeadingTextWrapper">
          <div className="commentHeadingFullName">
            <div className="commentHeadingTextFullName">
          ...
          <div className="commentTextReplyTo">
            Replying to{' '}
            <span
              className="commentReplyUsername"
              onClick={() => {
                props.handleSearch(props.currentPost.username);
              }}>
