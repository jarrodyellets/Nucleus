    ...
    <div className="exploreInnerWrapper">
      ...
      <div className="profileCardInfoWrapper">
        <div className="profileCardNameWrapper">
          ...
          {props.userData.id != props.user.id & props.userData.following.indexOf(props.user.id) == -1 ? <button onClick={() => {props.handleFollow(props.user.id)}} className="profileCardFollowButton">Follow</button> : null}
        </div>
